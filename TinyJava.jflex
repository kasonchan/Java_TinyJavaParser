...
"{"				{ echo (); return symbolFactory . newSymbol ("(operator, {)", Symbol . LBRACE); }
"}"				{ echo (); return symbolFactory . newSymbol ("(operator, })", Symbol . RBRACE); }
...
"java.util.*" 	{ echo (); return symbolFactory . newSymbol ("(keyword, java.util.*)", Symbol . JAVAUTIL); }
